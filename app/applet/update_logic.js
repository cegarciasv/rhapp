...
const files = [
  { name: '16pf.html', path: '/app/applet/public/tests/16pf.html' },
  { name: 'cleaver.html', path: '/app/applet/public/tests/cleaver.html' },
  { name: 'integra.html', path: '/app/applet/public/tests/integra.html' },
  { name: 'moss.html', path: '/app/applet/public/tests/moss.html' }
];
