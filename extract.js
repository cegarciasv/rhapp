...
if (files.length >= 4) {
  fs.writeFileSync('/public/tests/16pf.html', files[0]);
  fs.writeFileSync('/public/tests/cleaver.html', files[1]);
  fs.writeFileSync('/public/tests/integra.html', files[2]);
  fs.writeFileSync('/public/tests/moss.html', files[3]);
